class Ending3 extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.text(WIDTH * 0.5, HEIGHT * 0.4, ENDING_PLOTS[2][endingPattern], {
        ...
        this.input.on('pointerup', () => {
            this.tweens.add({ targets: rect, duration: 500, alpha: 1, onComplete:  () => this.scene.start('ending4', { powderCount: this.powderCount })});
        });
    }
