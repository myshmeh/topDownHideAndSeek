class Opening2 extends Phaser.Scene {
    ...
    create() {
        this.add.text(WIDTH * 0.5, HEIGHT * 0.4, PLOTS[1].toUpperCase(), {
        ...
        this.add.image(WIDTH * 0.5, HEIGHT * 0.7, 'trap', 0).setScale(4);
        this.add.image(WIDTH * 0.5, HEIGHT * 0.7, 'fiona_idle', 10).setScale(2).angle = 0;
