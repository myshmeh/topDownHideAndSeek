class Stage3 extends Phaser.Scene {
    ...
    createStatics() {
        ...
        this.traps.create(WIDTH * 0.2, HEIGHT * 0.525, 'slime');
        this.traps.create(WIDTH * 0.1, HEIGHT * 0.65, 'slime');
        this.traps.create(WIDTH * 0.3, HEIGHT * 0.7, 'slime');
        this.traps.create(WIDTH * 0.15, HEIGHT * 0.8, 'slime');
